...
rocks_raw <- terra::rast(x = file.path(raw_driver_dir, "raw-lithology-data",
...
rock_index_raw <- read.table(file = file.path(raw_driver_dir,
...
upload_spatial_output(lith_out_file)

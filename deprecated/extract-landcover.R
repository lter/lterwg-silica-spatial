...
landcover_out_file <- silica_driver_output_file(path, "si-extract_landcover")

# Export the summarized land cover data
write.csv(x = land_export, na = '', row.names = F,
          file = landcover_out_file)

# Upload to GoogleDrive
googledrive::drive_upload(media = landcover_out_file,
                          overwrite = T,

...
Adding day '-15' to Sampling Date column for HBR watershed data

```{r}


HBR_WATERSHEDS <- HBR_WATERSHEDS  %>% 
mutate('Sampling Date' = paste0(HBR_WATERSHEDS$`Sampling Date`, '-15'))
...
#ALL_WATERSHEDS[, c("LTER", "Site/Stream Name", "Sampling Date", "Time", "Temp C", "Conductivity", "Spec Cond", "Turbidity", "TSS", "VSS", "DSi", "TN", "DIN", "NOx", "NH4", "TP", "PO4", "SRP",
# "DOC", "TOC", "alkalinity", "ANC", "pH", "DIC", "Suspended Chl", "Na", "K", "Ca", "Mg", "SO4", "Cl","Comments"  )]

...
new_datatable6 <- na_if(new_datatable6, "-888.888")

new_datatable6 <- na_if(new_datatable6, "-888.88")
...
(lookup_table_units <- fuzzy_match %>%
  mutate(watershed_units_6 = case_when(
    solute_units_Template$Measurement %in% c("DO","Q", "DO%","TOC", "TDP","PON", "PP", "TKN","DOP","TN", "Si", "TP") ~ NA_character_,
